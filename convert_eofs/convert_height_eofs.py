...
def convert_height_eofs(
    ...
    attributes["ROOT"]["title"] = f"{DATASET} EOF variables"
    ...
    struct = dict(dimensions=("num", "y", "x"), variables={})
    ...
    for var in fields:
        ...
        CLM_FILE = EOF_FILE.with_name(
            f"{DATASET}{AUX}_{var}_{SEP}{REGION}_CLM_L{LMAX:d}{order_str}.nc"
        )
    ...
    FILE = (
        f"{DATASET}{AUX}_EOF_Height_{SEP}{REGION}"
        f"_L{LMAX:d}{order_str}{gw_str}.nc"
    )
