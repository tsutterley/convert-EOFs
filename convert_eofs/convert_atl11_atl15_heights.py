...
def convert_atl11_atl15_heights(INPUT_FILE, LMAX, MMAX=None,
    RAD=0, MASKS=None, ATL15=None, BUFFER=800e3, MODE=0o775):
    ...
    fields = sorted(set(fileID.variables.keys()) - set(fileID.dimensions.keys()))
...
def arguments():
    ...
    parser.add_argument('infile',
        type=pathlib.Path,
        help='Input ATL11/ATL15 data file')
...
def main():
    ...
    # run program
    convert_atl11_atl15_heights(args.infile, args.lmax,
        MMAX=args.mmax,
        RAD=args.radius,
        MASKS=args.mask,
        ATL15=args.atl15,
